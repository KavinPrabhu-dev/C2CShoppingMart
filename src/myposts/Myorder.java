...
public class Myorder extends javax.swing.JFrame {
    ...
    void Display() {
        ...
        electronicsButton.setText("REFRESH");
    ...
    public void electronicsButtonMouseClicked(java.awt.event.MouseEvent evt) {
    ...
    public void electronicsButtonActionPerformed(java.awt.event.ActionEvent evt) {

        cancelord.categoryChooser = "electronics";
        ArrayList<ProductList> list = ElectronicsDB1.TableGenerator();
        Object rowData[] = new Object[6];

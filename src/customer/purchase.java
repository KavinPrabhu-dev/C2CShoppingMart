            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                {
                    try {
                        ...
                        while (pch.next()) {
                            ...
                            String prd=pch.getString("p_name");
                            st.executeUpdate("update producttable set status='ordered' where user_id='" + pid + "' and p_name='"+prd+"' and status='approved'");
                            st.executeUpdate("update displaytable set status='ordered' where user_id='" + pid + "' and p_name='"+prd+"' and status='approved'");
                            st.executeUpdate("delete from producttable where status='no' and post_id='"+pid+"' and p_name='"+prd+"'");
                        }
